...
- [`EXT:heatmap_widget`](https://github.com/konradmichalik/typo3-heatmap-widget) – *A dashboard widget to display a (GitHub lookalike) contribution heatmap of e.g. content changes.*
...
- [`kmi/system-information-bundle`](https://github.com/konradmichalik/SystemInformationBundle) – *Sonata Admin bundle to display systemically relevant information.*
...
- [Lighthouse Garden](https://github.com/konradmichalik/lighthouse-garden) – *Monitoring performance data for websites using the lighthouse service.*
- [DDEV Commands Collection](https://github.com/konradmichalik/ddev-commands-collection) – *Collection of reusable DDEV commands.*
...
- [`ddev-openapi-mock`](https://github.com/konradmichalik/ddev-openapi-mock) – *DDEV add-on which provides a fake OpenAPI interface for local developing & testing.*

### 🐬 Side Projects

- [temps](https://github.com/konradmichalik/temps) – *Simple menubar application based on Electron with actual weather information and forecast.*
